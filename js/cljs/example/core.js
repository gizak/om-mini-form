...
example.core.main = (function main(){return om.core.root.call(null,(function (app,owner){if(typeof example.core.t7912 !== 'undefined')
{} else
{
/**
* @constructor
*/
example.core.t7912 = (function (owner,app,main,meta7913){
this.owner = owner;
this.app = app;
this.main = main;
...
example.core.t7912.cljs$lang$type = true;
example.core.t7912.cljs$lang$ctorStr = "example.core/t7912";
example.core.t7912.cljs$lang$ctorPrWriter = (function (this__4217__auto__,writer__4218__auto__,opt__4219__auto__){return cljs.core._write.call(null,writer__4218__auto__,"example.core/t7912");
});
example.core.t7912.prototype.om$core$IRenderState$ = true;
example.core.t7912.prototype.om$core$IRenderState$render_state$arity$2 = (function (_,s){var self__ = this;
var ___$1 = this;return cljs.core.apply.call(null,React.DOM.div,{"className": "container"},cljs.core.flatten.call(null,(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[om_tools.dom.element.call(null,React.DOM.h3,new cljs.core.Keyword(null,"headline","headline",-157157727).cljs$core$IFn$_invoke$arity$1(self__.app),cljs.core.PersistentVector.EMPTY),om_mini_form.core.build.call(null,self__.app,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"form","form",-1624062471)], null))],null))));
});
example.core.t7912.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_7914){var self__ = this;
var _7914__$1 = this;return self__.meta7913;
});
example.core.t7912.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_7914,meta7913__$1){var self__ = this;
var _7914__$1 = this;return (new example.core.t7912(self__.owner,self__.app,self__.main,meta7913__$1));
});
example.core.__GT_t7912 = (function __GT_t7912(owner__$1,app__$1,main__$1,meta7913){return (new example.core.t7912(owner__$1,app__$1,main__$1,meta7913));
});
}
return (new example.core.t7912(owner,app,main,null));
}),example.core.app_state,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"target","target",253001721),document.getElementById("app")], null));
});
example.core.main.call(null);
